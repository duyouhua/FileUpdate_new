...
public class Child3Adapter extends BaseAdapter {
    ...
    // 用来控制CheckBox的选中状况
    private static HashMap<Integer, Boolean> isSelectedchilld3;
//    private static HashMap<String, String> mapFamt;
//    private static HashMap<String, String> mapType;

    //参数初始化
    public Child3Adapter(Context context, ArrayList<String> na, ArrayList<String> pa) {
        names = na;
        paths = pa;
        mContext = context;
...
//        file = small(file, 1.1f);
        ...
        isSelectedchilld3 = new HashMap<Integer, Boolean>();
//        mapFamt = new HashMap<>();
//        mapType = new HashMap<>();
    ...
    private void initDate() {
        for (int i = 0; i < paths.size(); i++) {
            ...
            getIsSelectedchilld3().put(i, false);
...
//                            mapType.put(f.getAbsolutePath(), "2");
                        ...
                        Log.i("QWEQWE", getIsSelectedchilld3().get(position) + "");
                    } else {
    ...
    public static HashMap<Integer, Boolean> getIsSelectedchilld3() {
//        isSelected.clear();
        return isSelectedchilld3;
    }

    public static void setIsSelectedchilld3(HashMap<Integer, Boolean> isSelected) {
        isSelectedchilld3 = isSelected;
    }

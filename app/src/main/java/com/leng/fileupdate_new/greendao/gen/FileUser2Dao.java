...
/** 
 * DAO for table "FILE_USER2".
*/
public class FileUser2Dao extends AbstractDao<FileUser2, Long> {

    public static final String TABLENAME = "FILE_USER2";

    /**
     * Properties of entity FileUser2.<br/>
    ...
    */
    ...
    public FileUser2Dao(DaoConfig config) {
        super(config);
    }
    
    public FileUser2Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FILE_USER2\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FILE_USER2\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FileUser2 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FileUser2 entity) {
        stmt.clearBindings();
    ...
    @Override
    public FileUser2 readEntity(Cursor cursor, int offset) {
        FileUser2 entity = new FileUser2( //
    ...
    @Override
    public void readEntity(Cursor cursor, FileUser2 entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(FileUser2 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FileUser2 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

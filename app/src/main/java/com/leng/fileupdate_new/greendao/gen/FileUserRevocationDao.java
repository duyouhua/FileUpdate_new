...
/** 
 * DAO for table "FILE_USER_REVOCATION".
*/
public class FileUserRevocationDao extends AbstractDao<FileUserRevocation, Long> {

    public static final String TABLENAME = "FILE_USER_REVOCATION";

    /**
     * Properties of entity FileUserRevocation.<br/>
    ...
    */
    ...
    public FileUserRevocationDao(DaoConfig config) {
        super(config);
    }
    
    public FileUserRevocationDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FILE_USER_REVOCATION\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FILE_USER_REVOCATION\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FileUserRevocation entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FileUserRevocation entity) {
        stmt.clearBindings();
    ...
    @Override
    public FileUserRevocation readEntity(Cursor cursor, int offset) {
        FileUserRevocation entity = new FileUserRevocation( //
    ...
    @Override
    public void readEntity(Cursor cursor, FileUserRevocation entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(FileUserRevocation entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FileUserRevocation entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
